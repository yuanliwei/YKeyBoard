...
public class Keyboard2View extends View
    ...
    private static final int _currentWhat = 0;
    private static final RectF _tmpRect = new RectF();
    private KeyboardData _keyboard;
    private final Pointers _pointers;
    private int _flags = 0;
    private final Vibrator _vibratorService;
